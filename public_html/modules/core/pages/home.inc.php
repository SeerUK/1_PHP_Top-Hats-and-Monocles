...
<div id="ostream">
  <div id="streambox">
    <object type="application/x-shockwave-flash" height="100%" width="100%" id="live_embed_player_flash" data="https://www.tophatsandmonocles.net/twitchtv/widgets/live_embed_player.swf?channel=<?php echo $stream->data['channel_name']; ?>" bgcolor="#000000">
      <param name="allowFullScreen" value="true" />
      <param name="allowScriptAccess" value="always" />
      <param name="allowNetworking" value="all" />
      <param name="movie" value="https://www.tophatsandmonocles.net/twitchtv/widgets/live_embed_player.swf" />
